...
open class TableViewSectionedDataSource<S: SectionModelType>
    ...
    public typealias ViewForHeaderInSection = (UITableView, Int, S) -> UIView?
    public typealias ViewForFooterInSection = (UITableView, Int, S) -> UIView?
    ...
    open func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        return viewForHeaderInSection(tableView, section, self[section])
    }

    open func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        return viewForFooterInSection(tableView, section, self[section])
    }
