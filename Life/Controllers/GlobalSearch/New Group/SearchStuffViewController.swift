...
class SearchStuffViewController: TabsController, TabsControllerDelegate, Stepper {
    ...
    init(stuffViewModel: StuffViewModel) {
        let vc1 = SearchNewsViewController(viewModel: stuffViewModel.searchNewsViewModel)
    ...
    override func prepare() {
        ...
        barView.frame = CGRect(x: view.frame.minX, y: view.frame.minY, width: view.bounds.width, height: topHeight)
    ...
    override func layoutSubviews() {
        ...
        let heightTab = tabBar.frame.height
        tabBar.frame = CGRect(x: 0, y: topHeight, width: view.bounds.width, height: heightTab)
    }
