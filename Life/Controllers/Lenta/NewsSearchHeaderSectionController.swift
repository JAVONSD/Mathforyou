...
class NewsSearchHeaderSectionController: ASCollectionSectionController {
    ...
    init(viewModel: NewsViewModel) {
        ...
        viewModel.loadingTop3
            .bind(to: loading)
            .disposed(by: disposeBag)
        
        viewModel.top3NewsObservable
...
extension NewsSearchHeaderSectionController: ASSectionController {
    func nodeBlockForItem(at index: Int) -> ASCellNodeBlock {
        ...
        return {
            ...
            let height = max(100 * UIScreen.main.bounds.size.width / UIScreen.main.bounds.size.width, 100) 
            
            let cell = NewsSearchSliderCell(
                slides: slides,
                height: height,
...
extension NewsSearchHeaderSectionController: RefreshingSectionControllerType {
