...
class SearchViewController: MagiSearchViewController, Stepper {
    ...
    override func viewDidLoad() {
        ...
        let demoCategories = ["Menu", "Animation", "Transition", "TableView", "CollectionView", "Indicator", "Alert", "UIView", "UITextfield", "UITableView", "Swift", "iOS", "Android", "News", "Vacansies", "Empolees", "Life"]
