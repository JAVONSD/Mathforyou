...
class IDPSectionController: ASCollectionSectionController {
    private(set) weak var viewModel: IDPViewModel?

    var onUnathorizedError: (() -> Void)?

    init(viewModel: IDPViewModel) {
    ...
    override func didUpdate(to object: Any) {
        self.viewModel = object as? IDPViewModel
...
extension IDPSectionController: ASSectionController {
    ...
    private func dashboardCell() -> ASCellNode {
        ...
        let config = DashboardCell.Config(
            image: "",
            title: NSLocalizedString("idp", comment: ""),
...
extension IDPSectionController: RefreshingSectionControllerType {
